        ...
        extends AbstractTestQueryFramework
{
    ...
    @Test
    @Flaky(issue = "https://github.com/trinodb/trino/issues/4173", match = "\\QExpected query to fail: SELECT * FROM (VALUES BOGUS(true), BOGUS(false), BOGUS(true))", since = "2023-10-27")
