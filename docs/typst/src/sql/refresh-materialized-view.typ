...
#anchor("doc-sql-refresh-materialized-view")
= REFRESH MATERIALIZED VIEW

== Synopsis

#code-block("text", "REFRESH MATERIALIZED VIEW view_name")

== Description

Initially populate or refresh the data stored in the materialized view #raw("view_name"). The materialized view must be defined with create-materialized-view. Data is retrieved from the underlying tables accessed by the defined query.
