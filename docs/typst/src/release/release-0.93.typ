...
#anchor("doc-release-release-0-93")
= Release 0.93
...
If you're upgrading from 0.92, you need to alter your verifier\_queries table

#code-block("sql", "ALTER TABLE verifier_queries add test_username VARCHAR(256) NOT NULL default 'verifier-test';
...
- Add optimizer for #raw("LIMIT 0")
- Fix incorrect check to disable string statistics in ORC
- Ignore hidden columns in #raw("INSERT") and #raw("CREATE TABLE AS") queries
