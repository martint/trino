        ...
        extends AbstractColumnReaderBenchmark<byte[][]>
{
    ...
    @Param
    private PositionLength positionLength;

    public BenchmarkBinaryColumnReader(Encoding encoding, FieldType type, PositionLength positionLength)
    {
        this.encoding = requireNonNull(encoding, "encoding is null");
        this.type = requireNonNull(type, "type is null");
        this.positionLength = requireNonNull(positionLength, "positionLengths is null");
    }

    public BenchmarkBinaryColumnReader()
    {
    }
