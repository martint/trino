        ...
        implements StreamReader
{
            ...
            throws IOException
    {
        ...
        Block block;
        if (presentStream == null) {
            block = new ByteArrayBlock(nextBatchSize, Optional.empty(), dataStream.getSetBits(nextBatchSize));
        }
        else {
            ...
            if (nullCount == 0) {
                ...
                block = new ByteArrayBlock(nextBatchSize, Optional.of(valueIsNull), dataStream.getSetBits(nextBatchSize, valueIsNull));
            }
            else {
