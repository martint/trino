            ...
            assertThat(query("SELECT reverse(lower(varchar_col)) FROM " + table.getName()))
                    ...
                    .hasPlan(output(
                            project(ImmutableMap.of("expr", expression(
                                            new Call(
                                                    FUNCTIONS.resolveFunction("reverse", ImmutableList.of(new TypeDescriptorProvider(VARCHAR.getTypeSignature()))),
                                                    ImmutableList.of(
                                                            new Call(
                                                                    FUNCTIONS.resolveFunction("lower", ImmutableList.of(new TypeDescriptorProvider(VARCHAR.getTypeSignature()))),
    ...
    public void testPartialProjectionPushDown()
    {
        try (TestTable table = newTrinoTable(
            ...
            ResolvedFunction concatFunction = FUNCTIONS.resolveFunction(
                    "concat",
                    ImmutableList.of(
                            new TypeDescriptorProvider(VARCHAR.getTypeSignature()),
                            new TypeDescriptorProvider(VARCHAR.getTypeSignature())));
                                    ...
                                    project(
                                            ImmutableMap.of(
                                                    "round_expr", expression(
                                                            new Call(
                                                                    FUNCTIONS.resolveFunction("round", ImmutableList.of(new TypeDescriptorProvider(BIGINT.getTypeSignature()))),
                                                    ...
                                                    "concat_on_same_col_with_lower", expression(
                                                            new Call(concatFunction, ImmutableList.of(
                                                                    ...
                                                                    new Call(
                                                                            FUNCTIONS.resolveFunction("upper", ImmutableList.of(new TypeDescriptorProvider(VARCHAR.getTypeSignature()))),
                                            ...
                                            "reverse_col_money", expression(
                                                    new Call(
                                                            FUNCTIONS.resolveFunction(
                                                                    "reverse",
                                                                    ImmutableList.of(new TypeDescriptorProvider(VARCHAR.getTypeSignature()))),
