...
public class FunctionDependencyDeclaration
{
    ...
    public static final class FunctionDependencyDeclarationBuilder
    {
        ...
        public FunctionDependencyDeclarationBuilder addTypeTemplate(TypeTemplate typeTemplate)
        {
    ...
    public static final class CastDependency
    {
        ...
        public String toString()
        {
            return format("cast(%s, %s)", TypeTemplates.render(fromType), TypeTemplates.render(toType));
        }
    }
}
