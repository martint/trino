...
/**
 * Round-trip and precision coverage for the datetime ↔ JSON casts. Forward casts (TIME, TIME
 * WITH TIME ZONE, TIMESTAMP, TIMESTAMP WITH TIME ZONE) produce a typed SQL/JSON datetime
 * scalar; the JSON value rendered as text shows the datetime's canonical string form because
 * RFC 8259 has no native datetime type. Round-tripping through JSON preserves the original
 * value at every precision.
 */
