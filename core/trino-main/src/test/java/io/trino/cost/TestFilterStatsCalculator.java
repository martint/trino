...
public class TestFilterStatsCalculator
{
    ...
    public void testAndStats()
    {
        ...
        assertExpression(new Logical(AND, ImmutableList.of(new Call(JSON_ARRAY_CONTAINS, ImmutableList.of(new Constant(JSON, JsonValue.of(JsonTypeUtil.jsonParse(Slices.utf8Slice("[]")))), new Reference(DOUBLE, "x"))), new Comparison(LESS_THAN, new Reference(DOUBLE, "x"), new Constant(DOUBLE, 0.0)))))
        ...
        assertExpression(new Logical(AND, ImmutableList.of(new Comparison(LESS_THAN, new Reference(DOUBLE, "x"), new Constant(DOUBLE, 0.0)), new Call(JSON_ARRAY_CONTAINS, ImmutableList.of(new Constant(JSON, JsonValue.of(JsonTypeUtil.jsonParse(Slices.utf8Slice("[]")))), new Reference(DOUBLE, "x"))))))
                .outputRowsCount(337.5)
                .symbolStats(new Symbol(DOUBLE, "x"), symbolAssert ->
                        symbolAssert.lowValue(-10)
                                .highValue(0)
        ...
        assertExpression(new Logical(AND, ImmutableList.of(
                new Call(JSON_ARRAY_CONTAINS, ImmutableList.of(new Constant(JSON, JsonValue.of(JsonTypeUtil.jsonParse(Slices.utf8Slice("[11]")))), new Reference(DOUBLE, "x"))),
                new Call(JSON_ARRAY_CONTAINS, ImmutableList.of(new Constant(JSON, JsonValue.of(JsonTypeUtil.jsonParse(Slices.utf8Slice("[13]")))), new Reference(DOUBLE, "x"))))))
                .outputRowsCountUnknown();
    ...
    public void testNotStats()
    {
        ...
        assertExpression(not(new Call(JSON_ARRAY_CONTAINS, ImmutableList.of(new Constant(JSON, JsonValue.of(JsonTypeUtil.jsonParse(Slices.utf8Slice("[]")))), new Reference(DOUBLE, "x")))))
                .outputRowsCountUnknown();
    }
