...
class TestJson2016Type
{
    ...
    void testStorageRoundTrip()
    {
        ...
        assertThat(JSON_2016.getObject(block, 0)).isEqualTo(duplicateObject);
        assertThat(JSON_2016.getObject(block, 1)).isEqualTo(numericArray);
        ...
        assertThat(JSON_2016.getObject(region, 0)).isEqualTo(numericArray);
