...
class TestJson2016Type
{
    ...
    void testBinaryStorageRoundTrip()
    {
        ...
        assertThat(JsonItems.asJsonValue((JsonItem) JSON_2016.getObject(block, 0))).isEqualTo(duplicateObject);
        assertThat(JsonItems.asJsonValue((JsonItem) JSON_2016.getObject(block, 1))).isEqualTo(numericArray);
        ...
        assertThat(JsonItems.asJsonValue((JsonItem) JSON_2016.getObject(region, 0))).isEqualTo(numericArray);
    ...
    void testWriteObjectAcceptsJsonValueView()
    {
        ...
        assertThat(JsonItems.asJsonValue((JsonItem) JSON_2016.getObject(targetBlock, 0))).isEqualTo(item);
    }
