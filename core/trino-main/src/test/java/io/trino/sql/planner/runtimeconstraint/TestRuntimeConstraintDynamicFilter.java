        ...
        extends BasePlanTest
{
    ...
    public void testAwaitableFilterPublishesFinalPredicate()
    {
        ...
        DynamicFilter filter = RuntimeConstraintDynamicFilter.create(manager, bindings(COLUMN), ImmutableList.of(COLUMN));
    ...
    {
        TaskRuntimeConstraintManager manager = manager();
        DynamicFilter filter = RuntimeConstraintDynamicFilter.create(manager, bindings(COLUMN, SECOND_COLUMN), ImmutableList.of(COLUMN, SECOND_COLUMN));
        ...
        manager.applyUpdates(new RuntimeConstraintUpdateBatch(
                ...
                ImmutableList.of(RuntimeConstraintSnapshot.finalSnapshot(
                        ...
                        new RuntimeMembershipPayload(
                                ImmutableList.of(Domain.none(BIGINT)),
                                NULL_SAFE,
                                false,
