        ...
        extends BasePlanTest
{
    ...
    public void testEquals()
    {
        ...
        testUnwrap("varchar(10)", "a = CAST('abc' AS char(3))", new Comparison(EQUAL, new Reference(createVarcharType(10), "a"), new Constant(createVarcharType(10), Slices.utf8Slice("abc"))));
        // unbounded varchar and char
        testUnwrap("varchar", "a = CAST('abc' AS char(3))", new Comparison(EQUAL, new Reference(VARCHAR, "a"), new Constant(VARCHAR, Slices.utf8Slice("abc"))));
    }
    ...
    public void testCharToVarcharCast()
    {
        ...
        testUnwrap("char(3)", "CAST(a AS varchar(3)) = VARCHAR 'abc'", new Comparison(EQUAL, new Reference(createCharType(3), "a"), new Constant(createCharType(3), Slices.utf8Slice("abc"))));

        // wider varchar (does not narrow): still unwraps
        testUnwrap("char(3)", "CAST(a AS varchar(10)) = VARCHAR 'abc'", new Comparison(EQUAL, new Reference(createCharType(3), "a"), new Constant(createCharType(3), Slices.utf8Slice("abc"))));

        // unbounded varchar: unwraps
        testUnwrap("char(3)", "CAST(a AS varchar) = VARCHAR 'abc'", new Comparison(EQUAL, new Reference(createCharType(3), "a"), new Constant(createCharType(3), Slices.utf8Slice("abc"))));
        ...
        testUnwrap("char(3)", "CAST(a AS varchar(3)) = VARCHAR ''", new Comparison(EQUAL, new Reference(createCharType(3), "a"), new Constant(createCharType(3), Slices.utf8Slice(""))));

        // narrowing cast (varchar shorter than char) is not injective on the source, so it must NOT be unwrapped
        testUnwrap("char(5)", "CAST(a AS varchar(3)) = VARCHAR 'abc'", new Comparison(EQUAL, new Cast(new Reference(createCharType(5), "a"), createVarcharType(3)), new Constant(createVarcharType(3), Slices.utf8Slice("abc"))));
    }
