...
public final class VariantOperators
{
    ...
    public static JsonPayload castToJson(@SqlType(StandardTypes.VARIANT) Variant value)
    {
        Slice json = VariantUtil.asJson(value);
        return json == null ? null : JsonPayload.of(json);
    }
    ...
    @ScalarOperator(CAST)
    @SqlType(StandardTypes.VARIANT)
    public static Variant castFromJson(@SqlType(StandardTypes.JSON) JsonPayload value)
    {
