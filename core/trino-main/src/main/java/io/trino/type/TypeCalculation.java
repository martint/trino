...
public final class TypeCalculation
{
    ...
    /**
     * Parses a calculated type-parameter expression (e.g. {@code min(38, x + y)}) into a structured
     * {@link NumericExpression}, so it can be inlined into a {@link io.trino.spi.type.TypeTemplate} and
     * evaluated without re-parsing the string at every bind.
     */
