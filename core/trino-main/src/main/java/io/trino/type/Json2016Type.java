        ...
        extends AbstractVariableWidthType
{
    ...
    {
        Slice encoding;
        if (value instanceof JsonValueView view) {
            encoding = view.copyEncoding();
        }
        else if (value instanceof EncodedJsonItem encodedJsonItem) {
            encoding = encodedJsonItem.encoding();
        }
        else {
            encoding = JsonItemEncoding.encode(JsonItems.materialize((JsonPathItem) value));
        }
