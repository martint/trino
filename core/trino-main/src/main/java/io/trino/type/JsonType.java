        ...
        implements VariableWidthType
{
    ...
    public Object getObject(Block block, int position)
    {
        ...
        return JsonValue.of(valueBlock.getParsedItemSlice(valuePosition));
    }
    ...
    private static boolean equalOperator(@BlockPosition JsonBlock leftBlock, @BlockIndex int leftPosition, @BlockPosition JsonBlock rightBlock, @BlockIndex int rightPosition)
    {
        return slicesEqualOrSemanticallyEqual(
                leftBlock.getParsedItemSlice(leftPosition),
                rightBlock.getParsedItemSlice(rightPosition));
    }

    @ScalarOperator(EQUAL)
    private static boolean equalOperator(JsonValue left, @BlockPosition JsonBlock rightBlock, @BlockIndex int rightPosition)
    {
        return slicesEqualOrSemanticallyEqual(left.payload(), rightBlock.getParsedItemSlice(rightPosition));
    }

    @ScalarOperator(EQUAL)
    private static boolean equalOperator(@BlockPosition JsonBlock leftBlock, @BlockIndex int leftPosition, JsonValue right)
    {
        return slicesEqualOrSemanticallyEqual(leftBlock.getParsedItemSlice(leftPosition), right.payload());
    }
