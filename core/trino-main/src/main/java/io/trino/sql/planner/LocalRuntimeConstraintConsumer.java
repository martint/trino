        ...
        implements RuntimeConstraintSourceConsumer
{
    ...
    private final BiConsumer<List<Domain>, Observation> collector;
    ...
    public LocalRuntimeConstraintConsumer(
            ...
            List<Type> laneTypes,
            BiConsumer<List<Domain>, Observation> collector,
    ...
    private void notifyCollector(List<Domain> result)
    {
        ...
        synchronized (lanesWithNull) {
            sawNulls = IntStream.range(0, laneTypes.size())
                    .mapToObj(lanesWithNull::contains)
                    .collect(toImmutableList());
        }
        collector.accept(result, new Observation(sawInputRow.get(), sawNulls));
    }
