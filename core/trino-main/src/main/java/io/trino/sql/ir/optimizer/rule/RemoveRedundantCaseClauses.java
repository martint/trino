 ...
 * <ul>
 *     <li>{@code Case([When(a, r1), When(b, r2), When(a, r3)], d) -> Match([When(a, r1), When(b, r2)], d)}
 *     <li>{@code Case([When(a, r1), When(true, r2), When(a, r3)], d) -> Match([When(a, r1)], r2)}
 *     <li>{@code Case([When(a, r1), When(false, r2), When(a, r3)], d) -> Match([When(a, r1)], d)}
