        ...
        extends SqlScalarFunction
{
    ...
    private static final JsonPathItem EMPTY_ARRAY_RESULT = JsonItems.encoded(new JsonArrayItem(ImmutableList.of()));
    private static final JsonPathItem EMPTY_OBJECT_RESULT = JsonItems.encoded(new JsonObjectItem(ImmutableList.of()));
            ...
            long errorBehavior)
    {
        ...
        ImmutableList.Builder<MaterializedJsonValue> builder = ImmutableList.builderWithExpectedSize(pathResult.size());
        for (JsonPathItem item : pathResult) {
            builder.add(JsonItems.asJsonValue(item));
        }
        List<MaterializedJsonValue> sequence = builder.build();
    ...
    private static JsonPathItem encodedResult(MaterializedJsonValue value)
    {
