...
{
    private static final JsonPayload JSON_NULL = JsonPayload.of(JsonItemEncoding.encode(JsonNull.JSON_NULL));

    private JsonScalarFunction() {}

    private static JsonPayload encode(Type type, Object value)
    {
        if (value == null) {
            return JSON_NULL;
        }
        return JsonPayload.of(JsonItemEncoding.encode(new TypedValue(type, value)));
    }

    @ScalarFunction("json_scalar")
    @SqlType(StandardTypes.JSON)
    public static JsonPayload fromUnknown(@SqlNullable @SqlType("unknown") Boolean value)
    {
        return JSON_NULL;
    }
    ...
    @ScalarFunction("json_scalar")
    @SqlType(StandardTypes.JSON)
    public static JsonPayload fromBoolean(@SqlNullable @SqlType(StandardTypes.BOOLEAN) Boolean value)
    {
    ...
    @ScalarFunction("json_scalar")
    @SqlType(StandardTypes.JSON)
    public static JsonPayload fromTinyint(@SqlNullable @SqlType(StandardTypes.TINYINT) Long value)
    {
    ...
    @ScalarFunction("json_scalar")
    @SqlType(StandardTypes.JSON)
    public static JsonPayload fromSmallint(@SqlNullable @SqlType(StandardTypes.SMALLINT) Long value)
    {
    ...
    @ScalarFunction("json_scalar")
    @SqlType(StandardTypes.JSON)
    public static JsonPayload fromInteger(@SqlNullable @SqlType(StandardTypes.INTEGER) Long value)
    {
    ...
    @ScalarFunction("json_scalar")
    @SqlType(StandardTypes.JSON)
    public static JsonPayload fromBigint(@SqlNullable @SqlType(StandardTypes.BIGINT) Long value)
    {
    ...
    @ScalarFunction("json_scalar")
    @SqlType(StandardTypes.JSON)
    public static JsonPayload fromReal(@SqlNullable @SqlType(StandardTypes.REAL) Long value)
    {
    ...
    @ScalarFunction("json_scalar")
    @SqlType(StandardTypes.JSON)
    public static JsonPayload fromDouble(@SqlNullable @SqlType(StandardTypes.DOUBLE) Double value)
    {
    ...
    @LiteralParameters("x")
    @SqlType(StandardTypes.JSON)
    public static JsonPayload fromVarchar(@SqlNullable @SqlType("varchar(x)") Slice value)
    {
    ...
    @LiteralParameters("x")
    @SqlType(StandardTypes.JSON)
    public static JsonPayload fromChar(
    ...
    @ScalarFunction("json_scalar")
    @SqlType(StandardTypes.JSON)
    public static JsonPayload fromDate(@SqlNullable @SqlType(StandardTypes.DATE) Long value)
    {
    ...
    @LiteralParameters("p")
    @SqlType(StandardTypes.JSON)
    public static JsonPayload fromTime(
    ...
    public static final class FromDecimal
    {
        ...
        @SqlType(StandardTypes.JSON)
        public static JsonPayload fromShort(
                @LiteralParameter("p") long precision,
        ...
        @LiteralParameters({"p", "s"})
        @SqlType(StandardTypes.JSON)
        public static JsonPayload fromLong(
                @LiteralParameter("p") long precision,
                @LiteralParameter("s") long scale,
