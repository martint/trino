...
public final class JsonOutputFunctions
{
    ...
    private static final EncodingSpecificConstants UTF_8 = new EncodingSpecificConstants(
            ...
            JsonItems.jsonText(new JsonArray(List.of())),
            JsonItems.jsonText(new JsonObject(List.of())));
    ...
    public static Slice jsonToVarchar(@SqlType(StandardTypes.JSON_2016) JsonItem jsonExpression, @SqlType(StandardTypes.TINYINT) long errorBehavior, @SqlType(StandardTypes.BOOLEAN) boolean omitQuotes)
    {
    ...
    public static Slice jsonToVarbinary(@SqlType(StandardTypes.JSON_2016) JsonItem jsonExpression, @SqlType(StandardTypes.TINYINT) long errorBehavior, @SqlType(StandardTypes.BOOLEAN) boolean omitQuotes)
    {
    ...
    @SqlType(StandardTypes.VARBINARY)
    public static Slice jsonToVarbinaryUtf8(@SqlType(StandardTypes.JSON_2016) JsonItem jsonExpression, @SqlType(StandardTypes.TINYINT) long errorBehavior, @SqlType(StandardTypes.BOOLEAN) boolean omitQuotes)
    {
        return serialize(jsonExpression, UTF_8, errorBehavior, omitQuotes);
    }
    ...
    @SqlType(StandardTypes.VARBINARY)
    public static Slice jsonToVarbinaryUtf16(@SqlType(StandardTypes.JSON_2016) JsonItem jsonExpression, @SqlType(StandardTypes.TINYINT) long errorBehavior, @SqlType(StandardTypes.BOOLEAN) boolean omitQuotes)
    {
    ...
    @SqlType(StandardTypes.VARBINARY)
    public static Slice jsonToVarbinaryUtf32(@SqlType(StandardTypes.JSON_2016) JsonItem jsonExpression, @SqlType(StandardTypes.TINYINT) long errorBehavior, @SqlType(StandardTypes.BOOLEAN) boolean omitQuotes)
    {
        return serialize(jsonExpression, UTF_32, errorBehavior, omitQuotes);
    }

    private static Slice serialize(JsonItem json, EncodingSpecificConstants constants, long errorBehavior, boolean omitQuotes)
    {
        if (omitQuotes) {
            Optional<Slice> scalarText = JsonItems.scalarText(json);
