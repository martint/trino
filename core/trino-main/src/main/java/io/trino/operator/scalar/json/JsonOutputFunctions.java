...
public final class JsonOutputFunctions
{
    ...
    public static Slice jsonToJson(@SqlType(StandardTypes.JSON) Object jsonExpression, @SqlType(StandardTypes.TINYINT) long errorBehavior, @SqlType(StandardTypes.BOOLEAN) boolean omitQuotes)
    {
