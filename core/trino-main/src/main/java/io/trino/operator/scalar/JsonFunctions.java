...
public final class JsonFunctions
{
    ...
    @ScalarFunction
    @SqlType(StandardTypes.BOOLEAN)
    public static boolean isJsonScalar(@SqlType(StandardTypes.JSON) JsonPayload json)
    {
    ...
    public static Slice jsonFormat(@SqlType(StandardTypes.JSON) JsonPayload slice)
    {
    ...
    public static JsonPayload jsonParse(@SqlType("varchar(x)") Slice slice)
    {
        return JsonPayload.of(jsonValue(JsonTypeUtil.jsonParse(slice)));
    }
    ...
    @ScalarFunction
    @SqlType(StandardTypes.BIGINT)
    public static Long jsonArrayLength(@SqlType(StandardTypes.JSON) JsonPayload json)
    {
    ...
    @ScalarFunction
    @SqlType(StandardTypes.BOOLEAN)
    public static Boolean jsonArrayContains(@SqlType(StandardTypes.JSON) JsonPayload json, @SqlType(StandardTypes.BOOLEAN) boolean value)
    {
    ...
    @ScalarFunction
    @SqlType(StandardTypes.BOOLEAN)
    public static Boolean jsonArrayContains(@SqlType(StandardTypes.JSON) JsonPayload json, @SqlType(StandardTypes.BIGINT) long value)
    {
        return jsonArrayContains(json.payload(), value);
    }
    ...
    @ScalarFunction
    @SqlType(StandardTypes.BOOLEAN)
    public static Boolean jsonArrayContains(@SqlType(StandardTypes.JSON) JsonPayload json, @SqlType(StandardTypes.DOUBLE) double value)
    {
        return jsonArrayContains(json.payload(), value);
    }
    ...
    @LiteralParameters("x")
    @SqlType(StandardTypes.BOOLEAN)
    public static Boolean jsonArrayContains(@SqlType(StandardTypes.JSON) JsonPayload json, @SqlType("varchar(x)") Slice value)
    {
        return jsonArrayContains(json.payload(), value);
    }
    ...
    @LiteralParameters("x")
    @SqlType(StandardTypes.JSON)
    public static JsonPayload varcharJsonArrayGet(@SqlType("varchar(x)") Slice json, @SqlType(StandardTypes.BIGINT) long index)
    {
        Slice result = jsonArrayGet(json, index);
        return result == null ? null : JsonPayload.of(result);
    }

    @SqlNullable
    @ScalarFunction
    @SqlType(StandardTypes.JSON)
    public static JsonPayload jsonArrayGet(@SqlType(StandardTypes.JSON) JsonPayload json, @SqlType(StandardTypes.BIGINT) long index)
    {
    ...
    @SqlNullable
    @SqlType(StandardTypes.VARCHAR)
    public static Slice jsonExtractScalar(@SqlType(StandardTypes.JSON) JsonPayload json, @SqlType(JsonPathType.NAME) JsonPath jsonPath)
    {
    ...
    @SqlNullable
    @SqlType(StandardTypes.JSON)
    public static JsonPayload varcharJsonExtract(@SqlType("varchar(x)") Slice json, @SqlType(JsonPathType.NAME) JsonPath jsonPath)
    {
    ...
    @SqlNullable
    @SqlType(StandardTypes.JSON)
    public static JsonPayload jsonExtract(@SqlType(StandardTypes.JSON) JsonPayload json, @SqlType(JsonPathType.NAME) JsonPath jsonPath)
    {
    ...
    @SqlNullable
    @SqlType(StandardTypes.BIGINT)
    public static Long jsonSize(@SqlType(StandardTypes.JSON) JsonPayload json, @SqlType(JsonPathType.NAME) JsonPath jsonPath)
    {
