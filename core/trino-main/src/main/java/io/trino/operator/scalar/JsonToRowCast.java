        ...
        extends SqlScalarFunction
{
    ...
    private static final MethodHandle METHOD_HANDLE = methodHandle(JsonToRowCast.class, "toRow", RowType.class, BlockBuilderAppender.class, JsonPayload.class);
    ...
    @UsedByGeneratedCode
    public static SqlRow toRow(RowType rowType, BlockBuilderAppender rowAppender, JsonPayload json)
    {
