    ...
    private MapTransformValuesFunction()
    {
        super(FunctionMetadata.scalarBuilder("transform_values")
                .signature(Signature.builder()
                        ...
                        .typeVariable("V1")
                        .typeVariable("V2")
                        .returnType(mapType(new TypeDescriptor("K"), new TypeDescriptor("V2")))
                        .argumentType(mapType(new TypeDescriptor("K"), new TypeDescriptor("V1")))
                        .argumentType(functionType(new TypeDescriptor("K"), new TypeDescriptor("V1"), new TypeDescriptor("V2")))
                        .build())
