        ...
        OptionalInt relatedChannel)
{
    ...
    public RuntimeConstraintRequest withChannel(int channel)
    {
        ...
        return new RuntimeConstraintRequest(constraintId, channel, kind, operator, nullAllowed, targetType, relatedChannel);
    }
    ...
    {
        return new RuntimeConstraintRequest(constraintId, channel, kind, operator, nullAllowed, Optional.of(requireNonNull(targetType, "targetType is null")), relatedChannel);
    }
