...
/**
 * SQL spec {@code <comparison predicate part 2> ::= <comp op> <row value predicand>}.
 * The {@code IS [NOT] DISTINCT FROM} forms live on {@link DistinctFromPredicate}.
 */
        ...
        extends Predicate
{
    ...
    @Deprecated
    public ComparisonPredicate(Operator operator, Expression right)
    {
        this(null, operator, right);
    }
