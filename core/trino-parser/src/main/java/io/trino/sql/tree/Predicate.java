...
/**
 * The {@code <predicate part 2>} fragment of the SQL spec: the operator and right-hand side(s)
 ...
 * <p>
 * Used in two positions: as the {@code clause} of a {@link Predicated}, and as a SQL:2023 F262
 * extended {@code CASE} WHEN operand where the LHS is the case operand.
 */
