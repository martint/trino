...
{
    /**
     * What this WHEN clause matches on. {@link Operand} carries a value expression — a boolean for
     * searched CASE, an equality target for simple CASE. {@link Partial} carries a SQL:2023 F262
     * predicate fragment evaluated against the surrounding simple-CASE operand.
     */
    public sealed interface Match
    {
        /**
         * The wrapped {@link Node}; used by tree-walking visitors.
         */
        Node node();
    }
     ...
     * {@code <when operand>} production) over the surrounding simple-CASE operand. The LHS is
     * supplied implicitly by the enclosing {@link SimpleCaseExpression}.
     */
     ...
     * instead.
     *
     * @deprecated Prefer {@link #getMatch()} and pattern-match on the {@link Match} variant.
     */
    @Deprecated
