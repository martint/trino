...
/**
 * Represents the SQL spec's {@code <predicate> ::= <row value predicand> <predicate part 2>} shape:
 * a value (the LHS) paired with a predicate (the part-2 fragment).
 * <p>
 * The same {@link Predicate} types appear in two positions in the spec — as the right-hand side of
 * a full predicate (this class), and as a SQL:2023 F262 extended {@code CASE} WHEN operand, where
        ...
        extends Expression
{
    ...
    @Deprecated
    public Predicated(Expression value, Predicate predicate)
    {
