...
class TestSqlParserRoutines
{
    ...
    {
        return new Predicated(identifier(name), new ComparisonPredicate(ComparisonPredicate.Operator.LESS_THAN, expression));
    }

    private static Predicated lte(String name, Expression expression)
    {
        return new Predicated(identifier(name), new ComparisonPredicate(ComparisonPredicate.Operator.LESS_THAN_OR_EQUAL, expression));
    }

    private static Predicated gt(String name, Expression expression)
    {
        return new Predicated(identifier(name), new ComparisonPredicate(ComparisonPredicate.Operator.GREATER_THAN, expression));
    }

    private static Predicated gte(String name, Expression expression)
    {
        return new Predicated(identifier(name), new ComparisonPredicate(ComparisonPredicate.Operator.GREATER_THAN_OR_EQUAL, expression));
    }
